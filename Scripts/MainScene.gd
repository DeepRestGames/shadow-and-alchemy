...
func _ready():
	...
	alchemical_circle_1.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	alchemical_circle_2.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	alchemical_circle_3.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	opal_stone.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	item_mushroom.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	item_jarofgrapes.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	item_coal.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookblack_salt.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookblack_surfur.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookblack_mercury.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_aries.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_taurus.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_gemini.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_cancer.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_virgo.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_libra.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_scorpio.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_sagittarius.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_capricorn.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_aquarius.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	# item_bookred_projection.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	item_crucible.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	item_flintandsteel.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	item_gravedirt.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
	item_peppergrains.connect("item_was_interacted", play_sound_from_array.bind("item drop", $Audio/ItemInteract, item_interact_array))
